...
const emailRegistro = async (datos) => {
    ...
    const info = await transport.sendMail({
        ...
        <h3 style=color:#4f46e5;>Greetings ${nombre.toUpperCase()}, click the following link to confirm your account: <a href="${process.env.FRONTEND_URL}/veterinarios/confirm/${token}">Here</a></h3>
